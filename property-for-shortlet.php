...
<meta name="description" content="Find your desired home here">
    ...
    <title>Property for Shortlet Search</title>
<?php
    ...
    <section class="properties-list full featured portfolio blog">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="index.php">Home </a> &nbsp;/&nbsp; <span>  <a href="http://localhost/homes/property-for-shortlet.php?search=&type=property_name&status=&type=&city=city&city=&shortlet="> Shortlet</a> </span></p>
                                </div>
                               
                                <h3 class="search-title">For Shortlet Property Listings</h3>
                            </div>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="project-inner project-head">
                                    <div class="home">
                                        ...
                                        <a href="property-details.php?id=<?php echo $p_id ?>"
                                            ...
                                            <img src="images/property/<?php echo  $img; ?>" alt="<?php echo  $data['property_price']; ?>"
        ...
        <?php   }       
            ...
            <ul class="pagination lis-view">
                <?php 
                 $get = $prop->pagination_shortlet('property-for-shortlet.php',$page);?>
            </ul>
        </nav>
    </div>
</section>
