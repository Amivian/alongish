    ...
    <div class="container">
      <form action="editswap.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-8">
                <p>
                  ...
                  <input required type="text" name="swap_name" id="address"
                    value="<?php echo isset($property['swap_name']) ? $property['swap_name'] : ''; ?>">
                </p>
              </div>
              <div class="col-md-2">
                <p>
                  ...
                  <select name="swap_item" id="">
                    ...
                    <option value="Car"
                      <?php if (isset($property['swap_item']) && strtolower($property['swap_item']) == 'car') echo 'selected'; ?>>
                      Car</option>
                    <option value="House"
                      <?php if (isset($property['swap_item']) && strtolower($property['swap_item']) == 'house') echo 'selected'; ?>>
                      House</option>
                    <option value="Land"
                      <?php if (isset($property['swap_item']) && strtolower($property['swap_item']) == 'land') echo 'selected'; ?>>
                      Land</option>
                  </select>
                </p>
              </div>
              ...
              <div class="col-md-12">
                <p>
                  ...
                  <textarea id="description" name="swap_description"
                    required><?php echo isset($property['swap_description']) ? $property['swap_description'] : ''; ?></textarea>
            ...
            <div class="row">
              <div class="col-md-12 mb-4">
                <select name="swap_need" id="">
                  ...
                  <option value="Car"
                    <?php if (isset($property['swap_need']) && strtolower($property['swap_need']) == 'car') echo 'selected'; ?>>
                    Car</option>
                  <option value="House"
                    <?php if (isset($property['swap_need']) && strtolower($property['swap_need']) == 'house') echo 'selected'; ?>>
                    House</option>
                  <option value="Land"
                    <?php if (isset($property['swap_need']) && strtolower($property['swap_need']) == 'land') echo 'selected'; ?>>
                    Land</option>
                </select>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <p>
                  ...
                  <textarea id="description" name="sneed_description"
                    required><?php echo isset($property['sitem_description']) ? $property['sitem_description'] : ''; ?></textarea>
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <img src="images/swaps/<?php echo $img['image_url'] ?>" class="img-fluid"
                  alt="<?php echo $img['image_url'] ?>" width="200px">
        ...
        <div class="single-add-property">
          <div class="property-form-group">
            <div class="row">
              <button type="submit" class=" btn btn-success btn-lg mr-4" name="btn">Submit
                Swap</button>
