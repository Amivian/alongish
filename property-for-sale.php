                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="index.php">Home </a> &nbsp;/&nbsp; <span> <a href="http://localhost/homes/property-for-sale.php?search=&status=&type=property_name&type=&city=city&city=&sale=">Sale</a> </span></p>
                                </div>
                                <h3 class="search-title">For Sale Property Listings</h3>
                            </div>
                        </div>
                    </div>
                </section>
