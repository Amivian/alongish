            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12 blog-pots">
                        ...
                        <b><?php echo ucfirst($property['businessname']) ?></b> own this Property. Alongish will under no circumstances take liability for their inaccuracy; it simply acts as a channel for the advertisement of this property and is only communicating this property in good faith. Alongish.com does not guarantee the availability of any properties or deals advertised on the website, nor does it make any such statements.
                        Property particulars should be accessible directly from the agent marketing the property on Alongish.com; they are not included in the real estate advertisements and listings on our website. Prospective buyers and tenants must ascertain for themselves whether any property descriptions published are accurate, and agents must guarantee the integrity and accuracy of any property descriptions provided on our website.
                        </div>
                                        ...
                                        <div class="sidebar-widget author-widget2">
                                            ...
                                            <ul class="author__contact">
                                                <li ><span class="la la-phone"><i class="fa fa-phone"
                                                            aria-hidden="true"></i><a href="tel:<?php echo substr($property['a_phone'], 0,-6)?>***"  id="phone1" style="display:inline"><?php echo substr($property['a_phone'], 0,-6)?>***</a>
                                                            <a href="tel:<?php echo $property['a_phone'] ?>"  id="phone" style="display:none; margin-left:3px"> <?php echo $property['a_phone'] ?> </a></span>
                                                                   <!-- Button trigger modal -->
                                                        <button type="button" class="btn btn-sm btn-primary ml-3" data-toggle="modal" data-target="#exampleModalCenter" onclick="toogle()" >
                                                        View
                                                       </button>   
                                                </li>
                                                ...
                                                <li><span class="la la-envelope-o"><i class="fa fa-envelope"
                                                        ...
                                                        href="mailto:<?php echo  substr($property['a_email'], 0, -18)?>XXX" id="email1" style="display:inline"><?php echo  substr($property['a_email'],0,-18) ?>XXX</a>
                                                        <a
                                                        href="mailto:<?php echo $property['a_email']?>" id="email" style="display:none"><?php echo $property['a_email'] ?></a></span>
                                                          <!-- Button trigger modal -->
                                                          <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenter" onclick="toggle()">
                                                         View 
                                                       </button> 
                                                </li>
                                            </ul>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                   ...
                                   <b><?php echo ucfirst($property['businessname']) ?></b> own this Property. Alongish will under no circumstances take liability for their inaccuracy; it simply acts as a channel for the advertisement of this property and is only communicating this property in good faith. Alongish.com does not guarantee the availability of any properties or deals advertised on the website, nor does it make any such statements.
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal" style="border:none">Agree</button>
                                    </div>
                                    </div>
                                </div>
                                </div>
                ...
                <section class="similar-property featured portfolio p-0 bg-white-inner">
                    <div class="container">
                        ...
                        <?php
foreach ($swap as $new) {
    $img = $prop->getSwapImage($new['swap_id']);
 ?>	
                            <div class="item col-lg-4 col-md-6 col-xs-12 landscapes">
                                <div class="project-single">
                                    <div class="project-inner project-head">
                                        <div class="homes">                      
                                            <!-- homes img -->
                                            <a href="swap-details.php?id=<?php echo $new['swap_id'] ?>" class="homes-img" >
                                          
                                                <div class="homes-tag button alt featured">Swap</div>
                                                <div class="homes-tag button alt sale"><?php echo $new['swap_item'] ?></div>
                                                <img src="images/swaps/<?php echo $img;?>" alt="home-1" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="button-effect">
                                            <a href="swap-details.php?id=<?php echo $new['swap_id'] ?>"class="btn"><i class="fa fa-link"></i></a>
                                            <a href="swap-details.php?id=<?php echo $new['swap_id'] ?>" class="img-poppu btn"><i
                                    ...
                                    <div class="homes-content">
                                        <!-- swap address -->
                                        <h3><a href="swap-details.php?id=<?php echo $new['swap_id'] ?>"><?php echo ucwords($new['swap_name']); ?></a></h3>
                                        <p class="homes-address mb-3">
                                            <a href="swap-details.php?id=<?php echo $new['swap_id'] ?>">
                                                <i class="fa fa-map-marker"></i><span><?php echo ucwords($new['swap_address'])?> ,  <?php echo $new['city_name'] ?>, <?php echo $new['states_name'] ?></span>
                                            </a>
                                        </p>
                                    ...
                                    <a href="agent-details.html">
                                        <img style=" height: 40px; border-radius: 50%;"src="images/users/<?php echo $new['a_pix'] ?>" alt="" class="mr-2"><?php echo ucfirst($new['a_username'])?>
                                    </a>
