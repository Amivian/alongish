<?php
   require_once 'include/active-user.php';
            ...
            <div class="col-md-6 offset-3">
                <div id="login" class="mb-5">
                    <div class="login" style="max-width:440px !important">
                        ...
                        <div class=" user-login__info mb-3">Don't have an account? <a class=" user-login__info-link"
                        ...
                        <?php
                            if (isset($_SESSION['info'])) {
                                echo "<h6 class='alert alert-success text-center text-dark'>" . $_SESSION['info'] . "</h6>";
                                unset($_SESSION['info']);
                            }
                        ?>
                        <form id="user-form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  form-control-lg" name="email" id="email"
                                    placeholder="name@example.com or username" required value="">
                            ...
                            <div class="float-right mt-1"><a id="forgot" href="forgot-password.php">Forgot Password?</a>
                            </div>
                    </div>
                    <button id="login" class="btn_1 rounded" style="width:70%" name="login" type="submit">Login</button>
                    <div class="text-center add_top_10 mb-5">New to Alongish? <strong><a href="register.php">Sign
                                up!</a></strong></div>
                    </form>
                </div>
            </div>
