                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>
                                    ...
                                    <textarea id="description" name="joint_description"><?php echo $property['joint_description']; ?></textarea>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <p>
                                    ...
                                    <input type="text" name="address" value="<?php echo $property['address']; ?>">
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>
                                    ...
                                    <input type="text" name="offer" value="<?php echo $property['offer']; ?>">
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <p>
                                    ...
                                    <textarea id="description" name="joint_t&c"
                                        placeholder="Describe the property"><?php echo $property['joint_tc']; ?></textarea>
                                </p>
                            </div>
                        </div>
                    </div>
