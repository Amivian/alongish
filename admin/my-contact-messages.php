...
$output = $properties->getContactMessage($agent_id);
    ...
    <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
        ...
        <div class="my-properties">
            <table class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class='actions' style='text-align: center;padding-right:20px'> <a
                                href='deletesms.php?id=<?php echo $msg['message_id']?>' name='delete'
            ...
            <div class='pagination-container'>
                <nav>
                    <ul class=" pagination">
                        <?php $get = $properties->pagination_sms('my-contact-messages.php', $page, $agent_id);?>
                    </ul>
                </nav>
            </div>    
            <?php }else{ ?>
